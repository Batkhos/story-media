...
return (
  <div className=" h-screen  bg-black flex items-center justify-center">
    <div className="flex bg-blue-600 border border-white w-3/5 rounded-2xl overflow-hidden ">
      <div className="flex-1 flex flex-col gap-8 px-20 pb-20 sm:pb-0">
        <h2 className="text-primary mt-6 text-center font-extrabold ">Story-Day Log In<br /></h2>
        ...
        <div className='text-center items-center'>
            <span className="text-sm font-medium">Dont't Have An Account ?</span>
            <Link to='/Register'><button type='submit' className="ml-24 h-12 mt-2 grid w-28 items-center pointer-events-auto rounded-md bg-blue-900  py-2 text-[0.8125rem] font-semibold leading-5  text-white hover:bg-indigo-500 hover:text-black hover:font-bold">Register</button></Link>     
            </div>
      </div>
      <form className=" h-96 flex-1 bg-blue-600 flex flex-col items-center justify-center gap-2"> 
        ...
        <button type='submit' className="ml-1 h-12 w-28 pointer-events-auto rounded-md bg-blue-900 px-3 py-2 text-[0.8125rem] font-semibold leading-5  text-white hover:bg-indigo-500 hover:text-black hover:font-bold">Log In</button>
      </form>
    </div>
  </div>
)}